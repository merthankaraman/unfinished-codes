...
#define wire_konum 8
const int veri_sinir = 17;
char alinan_veri[veri_sinir] = "G1023/F0/Y1/", gonderilen_veri[veri_sinir]="IYI";

String gaz_string, fren_string;
char gaz_char[7] ={}, fren_char[7] {}, yon_char[2] = {};
...
void wire_verileri_duzenle(){
  char harf;
  memset(gaz_char, 0, sizeof(gaz_char)); memset(fren_char, 0, sizeof(fren_char)); memset(yon_char, 0, sizeof(yon_char));
...
void verileri_duzenle(){
  ...
  String gaz_string = gaz_char, fren_string = fren_char, yon_string = yon_char;
