...
float pil_1_katsayi = 1, pil_2_katsayi = (((10000.0+10000.0) / 10000.0) / 2.0), pil_3_katsayi = (((10000.0+5000.0) / 5000.0) / 3.0);
float pil_4_katsayi = (((10000.0+3300.0) / 3300.0) / 4.0), pil_5_katsayi = (((10000.0+2700.0) / 2700.0) / 5.0), pil_6_katsayi = (((10000.0+2200.0) / 2200.0) / 6.0);

float pil_7_katsayi = (((10000.0+1800.0) / 1800.0) / 7.0), pil_8_katsayi = (((10000.0+1500.0) / 1500.0) / 8.0), pil_9_katsayi = (((4700.0+680.0) /680.0) / 9.0);
float pil_10_katsayi = (((4700.0+560.0) /560.0) / 10.0), pil_11_katsayi = (((4700.0+470.0) / 470.0) / 11.0), pil_12_katsayi = (((3900.0+390.0) /390.0) / 12.0);

float pil_13_katsayi = (((3900.0+330.0) /330.0) / 13.0);
