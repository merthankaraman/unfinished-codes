...
*/
#define pwm_giris_pin (1<<PK0)   //Analog 8
#define fren_giris_pin (1<<PK1)  //Analog 9

#define a_yuksek_pin (1<<PB5) //Pin 11
#define a_dusuk_pin (1<<PC0)  //Pin 37

#define b_yuksek_pin (1<<PB6) //Pin 12
#define b_dusuk_pin (1<<PC1)  //Pin 36

#define c_yuksek_pin (1<<PB7) //Pin 13
#define c_dusuk_pin (1<<PC2)  //Pin 35
...
int tork_disi_guc = 1023;

int pwm_maks_deger = 1023, pwm_min_deger = 35, pwm_baslangic_deger = 35, motor_hiz;
