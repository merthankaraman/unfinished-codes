...
void istenen_koordinata_acila(){
  servo_3_istenen_aci = atan((z[0] + govde_yukseklik + ek_z_mesafe - istenen_koordinat[2])/(y[0] + ek_y_mesafe - istenen_koordinat[1])) * derece;
  ...
  servo_2_istenen_aci = atan((govde_yukseklik + ek_z_mesafe - istenen_koordinat[2])/(y[0] - istenen_koordinat[1])) * derece;
  ...
  servo_1_istenen_aci = atan((suanki_konum[1] - istenen_koordinat[1])/(suanki_konum[0] - istenen_koordinat[0])) * derece;
  suanki_konum[1] += suanki_konum[1] * sin((servo_1_istenen_aci + servo_1_sifirlama_payi) * radyan);
  suanki_konum[0] += suanki_konum[1] * cos((servo_1_istenen_aci + servo_1_sifirlama_payi) * radyan);
